        ...
        <View style={styles.table}>
            <View style={styles.tableRow}>
                ...
                <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>Type of Document Provided</Text>
                </View>
                <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>Country of Issue</Text>
                </View>

                <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>Date of Check</Text>
                </View>
                <View style={styles.tableCol}>
